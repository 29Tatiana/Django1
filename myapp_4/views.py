...
def product_update_form(request, product_id):
    ...
    return render(request, 'myapp_4/product_update.html', {'form': form})
...
def product_update_id_form(request):
    ...
    return render(request, 'myapp_4/product_update_id.html', {'form': form})


def index(request):
    return render(request, "myapp_4/index.html")
